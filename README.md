...
<head>
    ...
    <title>Fixed $250 Vinyl Installation for Bathrooms & Closets</title>
    <meta name="description" content="Professional vinyl floor installation for bathrooms and closets (30-60 sq. ft). Fixed $250 rate, including material and installation. Fast service by a trusted pro with big-box retailer experience."/>
    <meta name="keywords" content="vinyl floor installation, vinyl flooring, bathroom vinyl, closet vinyl, fixed price, small space installation, professional vinyl installer, Alves Renovation"/>
    <meta property="og:title" content="Vinyl Installation - Fixed $250 - Bathrooms & Closets" />
    <meta property="og:description" content="Professional vinyl installation for small spaces with a transparent, fixed price. Material + Installation for just $250." />
    <meta property="og:image" content="https://placehold.co/1200x630/0b1f33/ffffff?text=Alves+Renovation" />
    <meta property="og:url" content="https://alvesrenovationus.com" />
    <link rel="canonical" href="https://alvesrenovationus.com" />
    <!-- Tailwind CSS CDN -->
...
<body class="bg-gray-100">
            ...
            <div class="grid md:grid-cols-2 gap-10 items-center hero-grid">
                <div>
                    ...
                    <h1 class="text-3xl md:text-5xl font-extrabold leading-tight mb-4">
                        Professional Vinyl Installation for a <span class="text-accent">$250 Flat Rate</span>
                    </h1>
                ...
                <!-- Card for a professional look -->
                <div class="bg-secondary p-6 rounded-2xl shadow-lg border-2 border-gray-700">
                    <div class="flex items-center gap-2 text-gray-400 font-bold mb-2">
        ...
        <div class="container px-4 text-center">
            ...
            <div class="grid md:grid-cols-2 gap-6 max-w-2xl mx-auto">
                ...
                <div class="bg-white p-6 rounded-xl border-2 border-green-400 shadow-sm text-center">
                    ...
                    <p class="text-3xl md:text-4xl font-extrabold text-green-600 mt-2">$250 Flat Rate</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 bg-white">
        <div class="container px-4 grid md:grid-cols-2 gap-10">
            <div class="p-6 rounded-2xl border-2 border-gray-200 shadow-sm">
                <h2 class="text-2xl font-bold mb-4">What's Included in Your $250</h2>
                <ul class="list-none space-y-3 mb-6">
                    ...
                    <li class="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-gray-500 text-sm">Quality vinyl material is included in the price, for spaces up to 60 sq. ft.</p>
                        </div>
                    </li>
                    <li class="flex items-start gap-3">
                        <i class="fa-solid fa-check-circle text-green-500 text-lg mt-1"></i>
    ...
    <section id="contact" class="py-16 bg-gray-100">
        <div class="container px-4">
            ...
            <div class="bg-white p-8 md:p-10 rounded-2xl shadow-lg max-w-2xl mx-auto border-2 border-gray-200">
                <!-- Change the action URL to your Typeform URL -->
                <form id="leadForm" action="https://form.typeform.com/to/kiu0eyQn" method="POST" autocomplete="on" novalidate>
                    ...
                    <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
                        ...
                        <a href="#" id="textFormBtn" class="flex items-center gap-2 text-primary-bg font-bold px-4 py-2 rounded-full bg-gray-200 hover:bg-gray-300 transition">
    ...
    <!-- Footer -->
    <footer class="bg-primary text-gray-400 py-8">
        <div class="container px-4 text-center">
